...
export const WaitingOn: React.FC<AlliesAndEnemiesState> = (props) => {
    const what = WaitingOnTextRecord[props.currentTurn.status]
    const who = props.currentTurn.nominatedPlayer?.nickname
        ? props.currentTurn.nominatedPlayer?.nickname
        : props.currentTurn.currentPlayer.nickname
    return (
        <Box
